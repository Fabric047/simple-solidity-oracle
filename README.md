...
## **How Do Oracles Work?** 
A smart contract requests off-chain data (like the weather in Lima), the oracle retrieves it from an external API, verifies its accuracy using cryptographic proofs, and delivers it back to the blockchain.
